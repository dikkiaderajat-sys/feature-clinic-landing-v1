...
await fs.writeFile(path.join(output, 'styles.css'), css);
await fs.writeFile(path.join(output, 'index.html'), `<!doctype html><html lang="id"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="robots" content="${process.env.SITE_INDEXABLE === 'true' ? 'index,follow' : 'noindex,nofollow'}"><title>Clinic WhatsApp Booking Automation | Datautomasi</title><meta name="description" content="Otomatisasi booking klinik melalui WhatsApp untuk cek jadwal, booking, reschedule, pembatalan, dan pencatatan data pasien secara lebih cepat dan profesional."><link rel="icon" href="/assets/brand.png"><link rel="preload" href="/assets/inter-latin.woff2" as="font" type="font/woff2" crossorigin><link rel="stylesheet" href="/styles.css"></head><body>${markup}</body></html>`);
console.log('Built static landing page: out/index.html');
